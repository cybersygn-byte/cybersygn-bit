# Alternatives-directory backlink campaign
...
| # | Directory | URL | Domain rank | Notes |
|---|---|---|---|---|
...
## Submission template (works for most directories)

```
Product name: CyberSygn

Tagline: The e-signature tool that finds every field for you.
...
certificate that captures every event, IP address, and timestamp.
...
## Categories to claim (where the form asks)
...
## Screenshots to upload (where the form asks)

1. Field detection in action (animated GIF or 3-4 screenshots in sequence)
2. Pricing page (origin / solo / studio cards)
3. Sidebar with detection report + signing UI
4. Audit certificate sample
5. Comparison table from /alternatives/cybersygn-vs-docusign/

## Tracking

Keep a sheet:

| Directory | Submitted | Status | Listing URL | Traffic |
|---|---|---|---|---|
| G2 | YYYY-MM-DD | Pending | | |
| Capterra | YYYY-MM-DD | Pending | | |
| ... | | | | |

Revisit at week 4 and 8 for approval status. Some require a follow-up
email; some auto-approve.

## Pro move: review-trading

Once you're listed on G2/Capterra, encourage Origin customers to leave
a review. Even 3-5 reviews dramatically boost your discoverability
within the directory. Offer Origin customers a Studio-tier upgrade
or a month of credit in exchange for an honest review.
