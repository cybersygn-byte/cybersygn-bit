# Beachhead strategy (slice 102)

## The question

Who is CyberSygn for, specifically, for the next 90 days?

## The constraint

You cannot win every vertical at once. Solo founder, no sales team. Marketing dollars are time spent. Picking five audiences = no audience.
...
5. **DocuSign is overkill for them.** They want lightweight. You are lightweight.
6. **Coffee-shop ARPU.** $12/mo Solo is one fancy latte. Easy yes when the value is "saves 30 min per shoot."
...
## 90-day plan for the primary beachhead

### Days 1–14: Listen + show up
- Join: r/Freelance, r/Photography, r/Photographers, Indie Designer Slack, AIGA local, Hashtag Creatives Discord.
- Read 50 threads. Don't post anything. Identify the pain language.
- Find 5 community moderators. DM them: "Hey, I'm a fellow creative who built a tool that auto-detects signature fields in PDFs. Solves the contract-paperwork pain. Open to a quick chat?"
...
- Submit to: WeWorkRemotely tools section, Indie Hackers tools, Designer News, NoCode Founders newsletter, Maker Mag.
- Pitch one piece of guest content to: Creative Boom, AIGA Eye on Design, Format Magazine.
...
- Conversion rate from `?ref=` URLs higher than baseline traffic
- Community moderators voluntarily mention CyberSygn in threads
- A photographer DM's you saying "I sent 3 friends to your site"
- $1K MRR by day 60

## How to know if it isn't

- 60 days, less than 5 paying photographers/freelancers
- No conversation from community posts beyond polite acknowledgment
- All traffic from `?ref=hackernews` (i.e. indie audience), 0 from creative communities

If "isn't working" at day 60: switch to real estate or coaching. Don't switch sooner.

---

**One sentence to repeat to yourself for 90 days:**
*"I build for solo creative freelancers and photographers. Everyone else can wait."*
