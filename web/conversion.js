...
(function () {
  ...
  const TEMPLATE_TILES = [
    { type: 'business',        name: 'Master Services Agreement',  sub: 'Vendor contracts, retainer agreements, consulting MSAs.', layout: 'sig' },
    { type: 'confidentiality', name: 'Non-Disclosure Agreement',   sub: 'Mutual NDAs, one-way confidentiality, due-diligence wrappers.', layout: 'sig-init' },
    { type: 'employment',      name: 'Employment Agreement',       sub: 'W-2 offer letters, 1099 contractor agreements, advisor terms.', layout: 'sig-date' },
    { type: 'real-estate',     name: 'Rental Lease',               sub: 'Residential leases, commercial subleases, room rentals.', layout: 'sig-init' },
    { type: 'creative',        name: 'Photography Contract',       sub: 'Shoot agreements, model releases, image licensing.', layout: 'sig-date' },
    { type: 'professional',    name: 'Coaching Agreement',         sub: 'Engagement terms, intake forms, cancellation policies.', layout: 'sig' },
    { type: 'freelance',       name: 'Freelance Contract',         sub: 'Project SOWs, milestone payments, IP transfer clauses.', layout: 'sig-date' },
    { type: 'business',        name: 'SAFE / Investor Agreement',  sub: 'YC SAFE templates, convertible notes, advisor agreements.', layout: 'sig' },
    { type: 'professional',    name: 'Consulting Agreement',       sub: 'Independent consultant engagements, scope, IP, term.', layout: 'sig-date' },
    { type: 'freelance',       name: 'Independent Contractor',     sub: '1099 contractor work-for-hire, IP assignment, fee schedule.', layout: 'sig-date' },
    { type: 'professional',    name: 'Advisor Agreement',          sub: 'FAST-style agreement, equity grant, vesting, IP.', layout: 'sig' },
    { type: 'business',        name: 'Vendor Agreement',           sub: 'Standard vendor terms, payment, performance, exit.', layout: 'sig-init' },
    { type: 'events',          name: 'Speaker Agreement',          sub: 'Event speaker terms, fee, recording rights, cancellation.', layout: 'sig-date' },
    { type: 'events',          name: 'Sponsorship Agreement',      sub: 'Brand partnership tiers, deliverables, exclusivity.', layout: 'sig' },
    { type: 'finance',         name: 'Convertible Note',           sub: 'Promissory note that converts at next priced round.', layout: 'sig' },
    { type: 'finance',         name: 'Promissory Note',            sub: 'Borrower, lender, principal, interest, repayment terms.', layout: 'sig-date' },
    { type: 'finance',         name: 'Bill of Sale',               sub: 'Asset transfer, vehicle title, equipment sale.', layout: 'sig-date' },
    { type: 'personal',        name: 'Power of Attorney',          sub: 'General, durable, healthcare, financial POA forms.', layout: 'sig-init' },
    { type: 'personal',        name: 'Last Will and Testament',    sub: 'State-specific will templates and witness blocks.', layout: 'sig' },
    { type: 'personal',        name: 'Advance Healthcare Directive',sub: 'Living will, healthcare proxy, end-of-life wishes.', layout: 'sig' },
    { type: 'business',        name: 'LLC Operating Agreement',    sub: 'Multi-member or single-member LLC operating terms.', layout: 'sig-init' },
    { type: 'business',        name: 'Partnership Agreement',      sub: 'Partners, contributions, profit split, dissolution.', layout: 'sig-init' },
    { type: 'creative',        name: 'Licensing Agreement',        sub: 'IP license, scope, royalties, quality control, term.', layout: 'sig' },
    { type: 'creative',        name: 'Model Release',              sub: 'Image-rights grant for commercial and editorial use.', layout: 'sig-date' },
    { type: 'confidentiality', name: 'Mutual NDA',                 sub: 'Bilateral confidentiality between two business parties.', layout: 'sig' },
    { type: 'business',        name: 'Statement of Work',          sub: 'Scoped project under an MSA. Deliverables, dates, fee.', layout: 'sig-date' },
    { type: 'business',        name: 'Memorandum of Understanding',sub: 'Non-binding pre-contract alignment between parties.', layout: 'sig' },
    { type: 'tech',            name: 'Subscription Agreement',     sub: 'SaaS subscription terms, billing, data, termination.', layout: 'sig' },
  ];
