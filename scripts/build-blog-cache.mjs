...
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>CyberSygn blog. The boring details about contracts, signing, and time.</title>
  <meta name="description" content="Twice-a-week reading on electronic signatures, contracts, workflow, compliance, and the indie-founder side of building CyberSygn." />
  <meta name="robots" content="index, follow, max-image-preview:large" />
  ...
  <meta property="og:description" content="Reading on e-signature, contracts, workflow, and compliance. Twice a week." />
  <meta property="og:image" content="https://cybersygn.io/brand/og-image.png" />
  ...
  <main>
    <section class="hero">
      <div class="container">
        ...
        <h1 class="h-display hero__title">The boring details about signing, contracts, and time.</h1>
        <p class="lede hero__lede">Twice a week. E-signature mechanics, contract workflow, compliance basics, indie-founder lessons. Real value, no fluff.</p>
      </div>
    </section>
